...
class MainWidget(Widget):
    ...
    V_NB_LINES = 10
    V_LINES_SPACING = .25  # 25% in screen width
    vertical_lines = []
    ...
    def update_horizontal_lines(self):
        ...
        min_x = central_line_x + offset * spacing + self.current_offset_x
        max_x = central_line_x - offset * spacing + self.current_offset_x
    ...
    def transform_perspective(self, x, y):
        ...
        # and we change for linear => lin_y
        ...
        factor_y = pow(factor_y, 4)  # like factor_y * factor_y if 2,
    ...
    def update(self, dt):
        ...
        self.update_vertical_lines()
        self.update_horizontal_lines()
        self.current_offset_y += self.SPEED_X * time_factor
